...
pub(crate) fn hash_search_term(search_term: &SearchTerm) -> CryptoHash {
    let mut hash = CryptoHash::default();
    // Hash the Search Term and return it
    hash.copy_from_slice(&env::sha256(search_term.as_bytes()));
    hash
}
...
impl Contract {
    ...
    pub(crate) fn internal_transfer(
        ...
        let new_token = Token {
            ...
            author_id: token.author_id.clone(),
